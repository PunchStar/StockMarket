...
var KTamChartsChartsDemo = function() {
    ...
    var demo6 = function(data) {
        var tempArr;
        tempArr =  data['Time Series (Daily)'];
        // tempArr =  data['Weekly Time Series'];
        var users = []; 
        var i = 0;
        for (let value of Object.keys(tempArr)) {
            //   console.log('--------')
            //   console.log(value)
            //   console.log('--------')
            // if(i <= 10)
            users[i] = {"date":value,"value":Number(tempArr[value]['1. open'])};
            i ++;
            if(i > 49)
                break;
          }
          ...
          var chart = AmCharts.makeChart("kt_amcharts_6", {
            ...
            "dataProvider":users
            // "dataProvider":[{date: "2020-04-17", value: 121}
            // ,{date: "2020-04-20", value: 110.12}
            // ,{date: "2019-04-15", value: 108.21}
            // ,{date: "2020-04-18", value: 94.2}
            // ,{date: "2020-06-19", value: 98.12}]
            // "dataProvider":[
            //         {
            //             "date": "2020-04-16",
            //             "value": 118.8
...
jQuery(document).ready(function() {
    $.get("https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=IBM&apikey=demo", function(data, status){
        // $.get("https://www.alphavantage.co/query?function=TIME_SERIES_WEEKLY&symbol=IBM&apikey=demo", function(data, status){
    // alert("Data: " + data + "\nStatus: " + status);
    console.log('------')
    console.log()
    KTamChartsChartsDemo.init(data);
    console.log('------')
