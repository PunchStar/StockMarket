...
export class AuthService {
    ...
    login(emailAddress: string, hash: string): Observable<User> {
        ...
        return  this.getAllUsers().pipe(
            map((result: User[]) => {
                ...
                const user = find(result, (item: User) => {
                    ...
                    console.log(item)
                return (item['email'].toLowerCase() === emailAddress.toLowerCase());
                // return (item.emailAddress.toLowerCase() === emailAddress.toLowerCase());
                    // return (item.emailAddress === emailAddress && item.hash === hash);
                });
    	...
    	return this.http.get(API_USERS_URL).pipe(
            map((users: User[]) => {
                ...
                const user = find(users, (item: User) => {
                    return (item.emailAddress.toLowerCase() === email.toLowerCase());
                });
    ...
    getAllUsers(): Observable<User[]> {
		// return this.http.post<User[]>(API_USERS_URL + '/getAll',{});
