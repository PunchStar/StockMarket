...
export class ProductsListComponent implements OnInit, OnDestroy {
	...
	// displayedColumns = ['select', 'type', 'topic','actions'];
	// displayedColumns = ['select','type','ISIN','Issuer','IssuePrice','Coupon','MaturityDate','actions'];
	displayedColumns = ['type','ISIN','Issuer','IssuePrice','Coupon','MaturityDate','actions'];
	...
	ngOnInit() {
		...
		**/
		...
		this.subheaderService.setTitle('Stocks');
	...
	filterConfiguration(): any {
		...
		// }
		filter.ISIN = searchText;
		filter.Issuer = searchText;
		return filter;
	}
	...
	restoreState(queryParams: QueryParamsModel, id: number) {
		...
		// 	this.filterCondition = queryParams.filter.type.toString();
		// }
		// if ('ISIN' in queryParams.filter) {
		// 	this.filterCondition = queryParams.filter.ISIN.toString();
		// }
		// if ('Issuer' in queryParams.filter) {
		// 	this.filterCondition = queryParams.filter.Issuer.toString();
		// }
		...
		if ('type' in queryParams.filter) {
			this.filterStatus = queryParams.filter.type;
		}

		// if (queryParams.filter.model) {
		// 	this.searchInput.nativeElement.value = queryParams.filter.model;
		// }
		if (queryParams.filter.ISIN) {
			this.searchInput.nativeElement.value = queryParams.filter.ISIN;
		}
		if (queryParams.filter.Issuer) {
			this.searchInput.nativeElement.value = queryParams.filter.Issuer;
		}
	}
