...
export class UsersListComponent implements OnInit, OnDestroy {
	...
	// displayedColumns = ['select', 'id', 'firstName', 'lastName', 'emailAddress', 'phoneNumber','date','countryCitizenship', '_roles', 'actions'];
	// displayedColumns = [ 'id', 'firstName', 'lastName', 'emailAddress', 'phoneNumber','date','totalEquity', '_roles', 'actions'];
	displayedColumns = [ 'id', 'firstName', 'lastName', 'emailAddress', 'phoneNumber','date','totalEquity', 'accountType','employmentStatus', 'actions'];
	...
	filterConfiguration(): any {
		...
		filter.emailAddress = searchText;
	...
	fetchUsers() {
		...
		this.selection.selected.forEach(elem => {
			messages.push({
				text: `${elem.firstName}, ${elem.emailAddress}`,
				id: elem.id.toString(),
