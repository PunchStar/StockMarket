...
const routes: Routes = [
...

	{
		...
		children: [
			...
			{
				path: 'portfolio',
				loadChildren: () => import('app/views/pages/myportfolio/myportfolio.module').then(m => m.MyportfolioModule)
			},
			{
				path: 'settings',
			...
			{
				path: 'settingsadmin',
				loadChildren: () => import('app/views/pages/settingsadmin/settingsadmin.module').then(m => m.SettingsadminModule)
			},
			{
				path: 'manageusers',
			...
			{
				path: 'uploadmanage',
				loadChildren: () => import('app/views/pages/uploadmanage/uploadmanage.module').then(m => m.UploadmanageModule)
			},
			{
				path: 'mail',
