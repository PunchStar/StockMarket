...
exports.update = (req, res) => {
    ...
    WeddingInvitation.findById(userId, function(err, car) {
        ...
        if (req.body.boxedInvites)
            car.serviceOffered.boxedInvites = req.body.boxedInvites
        if (req.body.unboxedInvites)
            car.serviceOffered.unboxedInvites = req.body.unboxedInvites
        if (req.body.digitalECards)
            car.serviceOffered.digitalECards = req.body.digitalECards
        if (req.body.onlyCardDesign)
            car.serviceOffered.onlyCardDesign = req.body.onlyCardDesign
